/************************************************************************************************
* Created by: Victor Vaz                                                                        *
* Date: 2017/04/05																				*
* Last modification by: Victor Vaz																*
*                                                                                               *
******************************************Description********************************************
...
/* Index Name */ SELECT name FROM sys.indexes WHERE object_id = @object_id and index_id = @index_id		--Get IndexName
...
-- REBUILD locks tables and takes longer, though it does the best possible job
-- REORG locks pages and it's faster, though it just reorganizes the pages
...
/* Obtem Indices gerais de performance */
